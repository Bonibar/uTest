    ...
    <div class="row">
        ...
        if (!$utests) {
            ...
            foreach ($utests as $utest) {
                ...
                if ($utest->getUserId() == $_SESSION['user']->getId())
                    echo '<span class="pull-right glyphicon glyphicon-trash" rel="tooltip" data-placement="top" data-original-title="Supprimer ce test" style="cursor: pointer;" onclick="remove_test(this, '.$project->getId().', '.$utest->getId().');event.cancelBubble=true;"></span>';
...
<script type="application/javascript" src="js/remove.js"></script>
